...
int main(int argc, char** argv) {
  ...
  sub_new->add_option("filename", filename)->required();
  sub_new->final_callback(std::bind(WK::CMDS::newWiki, filename));
  ...
  sub_new->final_callback(std::bind(WK::CMDS::addEntry, title, tags, text));
